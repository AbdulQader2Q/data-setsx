...
public class SearchAnalysis {
    public static void main(String[] args) {
        ...
        //1.b store the data in an array List; Create a node for each word and add it to the list
        ...
        //2.a Call exhaustive search to return the frequency  of the word occurences in the dataset
        ...
        //3.b Call BST search method to find the frequency  of the word occurences in the BST
        ...
        //4.b Call AVL method search to return the frequency  of the word occurences in the AVL
    ...
    public static int exhaustiveSearch(int [] array)
    {
        //Place your code here
        /*1. Implement Exhastive Search Algorithm (Linear Search) that searches for the key
             in the list and returns its frequency  */
    ...
    public static ArrayList<String> readDataset(String dir){
        ...
        for (File f : folder) if (f.isFile()) files.add(f.getAbsolutePath());
